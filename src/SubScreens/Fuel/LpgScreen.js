    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#F4C50B', }}>
            <View style={{
                ...
                <Text style={{ fontSize: 40, fontWeight: 'bold', marginLeft: 115 }}>LPG</Text>
                <TouchableOpacity style={{ height: 25, width: 25, marginLeft: 113, marginTop: 15 }} onPress={() => navigation.navigate('Notifications')}>
                    <Image source={image.notification} style={{ height: 25, width: 25, marginLeft: 0 }} resizeMode={'contain'} />
                </TouchableOpacity>
            ...
            <View style={styles.inputStyle1}>
                ...
                />
                <Text style={{ fontSize: 20, marginTop: 3.5 }}>KGs.</Text>
            </View>
            <Text style={{ fontSize: 28, marginLeft: 290, marginTop: -50, marginLeft: 230, fontWeight: 'bold' }} >{price} ₹/KG.</Text>
            ...
            rowStyle={{backgroundColor:'#cecece'}}
            buttonStyle={{height:30,marginTop:100,marginLeft:50}}
