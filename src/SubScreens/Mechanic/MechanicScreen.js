  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F4C50B', }}>
      ...
      <View style={{
        ...
        <Text style={{ fontSize: 40, fontWeight: 'bold', marginLeft: 65 }}>Mechanic</Text>
        <TouchableOpacity style={{ height: 25, width: 25, marginLeft: 63, marginTop: 15 }} onPress={() => navigation.navigate('Notifications')}>
      ...
      <View style={styles.inputStyle}>
        ...
        /> */}
        <Text style={{fontSize:20,justifyContent:'center'}}>{location}</Text>
      </View>

      <TouchableOpacity style={{ flexDirection: 'row', marginTop: 20, marginLeft: 90, width: 250, height: 30 }} onPress={()=>setLocation(current)} >
