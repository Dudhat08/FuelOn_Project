    ...
    return (
        <View>
            ...
            <View style={styles.inputStyle1}>
                ...
                />
                <Text style={{ fontSize:RFValue(20,812), marginTop: 3.5 }}>Ltrs.</Text>
            </View>
            <Text style={{ fontSize: RFValue(30,812), marginLeft: 290, marginTop: -50, marginLeft: 230, fontWeight: 'bold' }} >{price} ₹/L.</Text>
